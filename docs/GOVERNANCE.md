...
> **Status 0.3.0:** Activering vereist aparte bronreview en regelreview. Geen huidige bron of regel is voor productie geactiveerd.
...
Een webcrawl maakt een bron nooit automatisch `active_reviewed`.
